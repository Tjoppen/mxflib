	...
	MXFLIB_TYPE_START(DictData_Types)
		...
		MXFLIB_TYPE_INTERPRETATION_REF("StrongRef", "Strong Reference", "UUID", "urn:x-ul:060E2B34.0104.0101.05020000.00000000", 0, ClassRefStrong, "")
		MXFLIB_TYPE_INTERPRETATION_REF("WeakRef", "Weak Reference", "UUID", "urn:x-ul:060E2B34.0104.0101.05010000.00000000", 0, ClassRefWeak, "")
		MXFLIB_TYPE_INTERPRETATION_REF("StrongReferenceTrack", "StrongReference to a Tracks", "StrongRef", "urn:x-ul:060E2B34.0104.0101.05021400.00000000", 0, ClassRefUndefined, "GenericTrack")
		...
		MXFLIB_TYPE_MULTIPLE("StrongReferenceVectorTrack", "Vector of StrongReferences to Tracks", "StrongReferenceTrack", "urn:x-ul:060E2B34.0104.0101.05060500.00000000", false, 0)
	...
	MXFLIB_CLASS_START(DictData_Classes)
		...
		MXFLIB_CLASS_SET("StructuralComponent", "Structural Component Superclass", "GenerationInterchangeObject", "urn:x-ul:060E2B34.0253.0101.0D010101.01010200")
			MXFLIB_CLASS_ITEM_REF("DataDefinition", "Data Definition - kind of data or metadata this structure refers to", ClassUsageRequired, "Label", 16, 16, 0x0201, "06 0e 2b 34 01 01 01 02  04 07 01 00 00 00 00 00", ClassRefGlobal, "", NULL, NULL)
		...
		MXFLIB_CLASS_SET("GenericDescriptor", "Generic Descriptor", "GenerationInterchangeObject", "")
			...
			MXFLIB_CLASS_VECTOR_END
			MXFLIB_CLASS_ITEM_REF("SubDescriptor", "Strong reference to a sub descriptor set", ClassUsageOptional, "UUID", 0, 0, 0x0000, "06 0e 2b 34 01 01 01 0a  06 01 01 04 02 10 00 00", ClassRefStrong, "SubDescriptor", NULL, NULL)
			MXFLIB_CLASS_VECTOR_REF("SubDescriptors", "Ordered array of strong references to sub descriptor sets", ClassUsageOptional, 0x0000, "06 0e 2b 34 01 01 01 0a  06 01 01 04 06 10 00 00", ClassRefStrong, "SubDescriptor")
				MXFLIB_CLASS_ITEM("SubDescriptor", "Strong reference to a sub descriptor set", ClassUsageOptional, "UUID", 0, 0, 0x0000, "", NULL, NULL)
			MXFLIB_CLASS_VECTOR_END
		MXFLIB_CLASS_SET_END
	...
	MXFLIB_TYPE_START(DictData_Types_3)
		...
		MXFLIB_MASKED_LABEL("MXFOPAtom", "MXF Specialized OP Atom", "06.0E.2B.34.04.01.01.01.0D.01.02.01.10.00.00.00", "00.00.00.00.00.00.00.00.00.00.00.00.00.03.00.00")
